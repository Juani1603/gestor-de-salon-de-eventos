  ...
  return (
    <div className="flex gap-6 items-start">
      <div className="flex-1 space-y-6 min-w-0">
        ...
        {/* Calendar card */}
        <div className="bg-white border border-[#F0F0F0] rounded-2xl p-4 sm:p-6">
      ...
      >
        ...
        <div className="fixed top-0 right-0 w-96 bg-white z-50 h-screen overflow-y-auto shadow-2xl lg:static lg:h-full lg:shadow-none lg:rounded-2xl lg:border lg:border-[#F0F0F0] lg:self-stretch lg:overflow-hidden"
          style={{
